...
import edu.fscj.cop3024c.seniorhelper.service.ModuleService;
...
public class ModuleController {
    ...
    public ResponseEntity<ModuleDto> create(@Valid @RequestBody ModuleDto moduleDto) {
        Profiler profiler = new Profiler("createModule");
        profiler.start("Create Module");
    ...
    public ResponseEntity<ModuleDto> update(@PathVariable Integer moduleId, @RequestBody ModuleDto moduleDto) {
        Profiler profiler = new Profiler("updateModule");
        profiler.start("Update Module");
    ...
    public ResponseEntity<Module> deleteModule(@PathVariable Integer id) {
        Profiler profiler = new Profiler("deleteModule");
        profiler.start("Delete Module");
